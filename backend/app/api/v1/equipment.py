...
@router.post("", response_model=EquipmentOut, dependencies=[Depends(require_roles(WRITE_ROLES))])
...
@router.patch("/{equipment_id}", response_model=EquipmentOut, dependencies=[Depends(require_roles(WRITE_ROLES))])
...
@router.post("/{equipment_id}/maintenance", response_model=EquipmentOut, dependencies=[Depends(require_roles(WRITE_ROLES))])
