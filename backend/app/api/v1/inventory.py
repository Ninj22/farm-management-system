...
@router.post("", response_model=InventoryItemOut, dependencies=[Depends(require_permission("inventory.create"))])
...
@router.patch("/{item_id}", response_model=InventoryItemOut, dependencies=[Depends(require_permission("inventory.update"))])
...
@router.post("/{item_id}/transactions", response_model=InventoryItemOut, dependencies=[Depends(require_permission("inventory.adjust"))])
